...
import TableSampleClients from '../../components/Table/AnnouncementsTable'
...
const Content = () => {
  ...
  const handleModalAction = async () => {
    ...
    await ApiAddData('annousments', { imgURL, flag, url, end_at }, (data) => {
      if (data.errMsg != '')
        return (
          <>
  ...
  return (
    <>
      {!Loading ? (
        <>
          <Head>
            <title>{getPageTitle('Annousments')}</title>
          </Head>
          <SectionMain>
            <SectionTitleLineWithButton icon={mdiTableBorder} title="Annousments" main>
              <Button
                    ...
                    >
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
                          <span className="font-semibold">Click to upload course Image</span> or
                          drag and drop
                        </p>
